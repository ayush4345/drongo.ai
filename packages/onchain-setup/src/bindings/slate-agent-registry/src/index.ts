...
export interface Client {
   ...
   */
  get_channel: ({channel_id}: {channel_id: u256}, options?: MethodOptions) => Promise<AssembledTransaction<ChannelEntry>>
   ...
   */
  close_channel: ({channel_id, caller}: {channel_id: u256, caller: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  register_channel: ({channel_id, rate_commitment, consumer_pubkey_x, consumer_pubkey_y, depositor, provider, token}: {channel_id: u256, rate_commitment: u256, consumer_pubkey_x: u256, consumer_pubkey_y: u256, depositor: string, provider: string, token: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  validate_for_settlement: ({channel_id, public_signals}: {channel_id: u256, public_signals: Array<u256>}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAADENoYW5uZWxFbnRyeQAAAAIAAAAAAAAABnJlY29yZAAAAAAH0AAAAA1DaGFubmVsUmVjb3JkAAAAAAAAAAAAAAZzdGF0dXMAAAAAB9AAAAANQ2hhbm5lbFN0YXR1cwAAAA==",
        ...
        "AAAAAAAAAEBSZXR1cm4gdGhlIGNoYW5uZWwgcmVjb3JkIGFuZCBsaWZlY3ljbGUgc3RhdHVzIGZvciBgY2hhbm5lbF9pZGAuAAAAC2dldF9jaGFubmVsAAAAAAEAAAAAAAAACmNoYW5uZWxfaWQAAAAAAAwAAAABAAAH0AAAAAxDaGFubmVsRW50cnk=",
        ...
        "AAAAAAAAAEpNYXJrIGEgY2hhbm5lbCBjbG9zZWQuIE9ubHkgdGhlIHJlZ2lzdGVyZWQgZGVwb3NpdG9yIG9yIHByb3ZpZGVyIG1heSBjYWxsLgAAAAAADWNsb3NlX2NoYW5uZWwAAAAAAAACAAAAAAAAAApjaGFubmVsX2lkAAAAAAAMAAAAAAAAAAZjYWxsZXIAAAAAABMAAAAA",
        "",
        "" ]),
      options
    )
  }
  public readonly fromJSON = {
    get_channel: this.txFromJSON<ChannelEntry>,
        has_channel: this.txFromJSON<boolean>,
        close_channel: this.txFromJSON<null>,
        register_channel: this.txFromJSON<null>,
        validate_for_settlement: this.txFromJSON<null>
  }
}